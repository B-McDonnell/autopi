...
if __name__ == '__main__':
    ...
    shared_parser.add_argument('FILENAME', nargs='?', help='path to configuration file. Fails if file not not exist. Uses /etc/wpa_supplicant/wpa_supplicant.conf by default',
                        default='/etc/wpa_supplicant/wpa_supplicant.conf')

    get_parser = subparsers.add_parser(
        'get', help='get the current country code. Fails if country code does not exist', parents=[shared_parser])
